...
#define SHLD_B1_Pin GPIO_PIN_1
#define SHLD_B1_GPIO_Port GPIOA
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define SHLD_B2_Pin GPIO_PIN_4
#define SHLD_B2_GPIO_Port GPIOA
#define SHLD_B3_Pin GPIO_PIN_0
#define SHLD_B3_GPIO_Port GPIOB
