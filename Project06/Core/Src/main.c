...
static ADC_info_t adc_capture = {
	.handle = &hadc1,
	.freq = 0,
	.signal = Arbitrary,
	.maxv = 0,
	.minv = 4095,
	.read_period = 2000,	// default read period is 500 milliseconds
	.mode = waiting,
	.samples = 0,
	.replay_length = 0
};

uint32_t wave_points[WAVE_POINTS];
...
int main(void)
{
  ...
  // will never get here gets rid of ekg warning
  ekg[1]=0;
  /* USER CODE END 3 */
}
